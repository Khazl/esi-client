...
```php
getUniverseAncestries($accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseAncestries200Ok[]
```
...
[**\EsiClient\Model\GetUniverseAncestries200Ok[]**](../Model/GetUniverseAncestries200Ok.md)
...
```php
getUniverseAsteroidBeltsAsteroidBeltId($asteroid_belt_id, $datasource, $if_none_match): \EsiClient\Model\GetUniverseAsteroidBeltsAsteroidBeltIdOk
```
...
[**\EsiClient\Model\GetUniverseAsteroidBeltsAsteroidBeltIdOk**](../Model/GetUniverseAsteroidBeltsAsteroidBeltIdOk.md)
...
```php
getUniverseBloodlines($accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseBloodlines200Ok[]
```
...
[**\EsiClient\Model\GetUniverseBloodlines200Ok[]**](../Model/GetUniverseBloodlines200Ok.md)
...
```php
getUniverseCategoriesCategoryId($category_id, $accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseCategoriesCategoryIdOk
```
...
[**\EsiClient\Model\GetUniverseCategoriesCategoryIdOk**](../Model/GetUniverseCategoriesCategoryIdOk.md)
...
```php
getUniverseConstellationsConstellationId($constellation_id, $accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseConstellationsConstellationIdOk
```
...
[**\EsiClient\Model\GetUniverseConstellationsConstellationIdOk**](../Model/GetUniverseConstellationsConstellationIdOk.md)
...
```php
getUniverseFactions($accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseFactions200Ok[]
```
...
[**\EsiClient\Model\GetUniverseFactions200Ok[]**](../Model/GetUniverseFactions200Ok.md)
...
```php
getUniverseGraphicsGraphicId($graphic_id, $datasource, $if_none_match): \EsiClient\Model\GetUniverseGraphicsGraphicIdOk
```
...
[**\EsiClient\Model\GetUniverseGraphicsGraphicIdOk**](../Model/GetUniverseGraphicsGraphicIdOk.md)
...
```php
getUniverseGroupsGroupId($group_id, $accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseGroupsGroupIdOk
```
...
[**\EsiClient\Model\GetUniverseGroupsGroupIdOk**](../Model/GetUniverseGroupsGroupIdOk.md)
...
```php
getUniverseMoonsMoonId($moon_id, $datasource, $if_none_match): \EsiClient\Model\GetUniverseMoonsMoonIdOk
```
...
[**\EsiClient\Model\GetUniverseMoonsMoonIdOk**](../Model/GetUniverseMoonsMoonIdOk.md)
...
```php
getUniversePlanetsPlanetId($planet_id, $datasource, $if_none_match): \EsiClient\Model\GetUniversePlanetsPlanetIdOk
```
...
[**\EsiClient\Model\GetUniversePlanetsPlanetIdOk**](../Model/GetUniversePlanetsPlanetIdOk.md)
...
```php
getUniverseRaces($accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseRaces200Ok[]
```
...
[**\EsiClient\Model\GetUniverseRaces200Ok[]**](../Model/GetUniverseRaces200Ok.md)
...
```php
getUniverseRegionsRegionId($region_id, $accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseRegionsRegionIdOk
```
...
[**\EsiClient\Model\GetUniverseRegionsRegionIdOk**](../Model/GetUniverseRegionsRegionIdOk.md)
...
```php
getUniverseStargatesStargateId($stargate_id, $datasource, $if_none_match): \EsiClient\Model\GetUniverseStargatesStargateIdOk
```
...
[**\EsiClient\Model\GetUniverseStargatesStargateIdOk**](../Model/GetUniverseStargatesStargateIdOk.md)
...
```php
getUniverseStarsStarId($star_id, $datasource, $if_none_match): \EsiClient\Model\GetUniverseStarsStarIdOk
```
...
[**\EsiClient\Model\GetUniverseStarsStarIdOk**](../Model/GetUniverseStarsStarIdOk.md)
...
```php
getUniverseStationsStationId($station_id, $datasource, $if_none_match): \EsiClient\Model\GetUniverseStationsStationIdOk
```
...
[**\EsiClient\Model\GetUniverseStationsStationIdOk**](../Model/GetUniverseStationsStationIdOk.md)
...
```php
getUniverseStructuresStructureId($structure_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetUniverseStructuresStructureIdOk
```
...
[**\EsiClient\Model\GetUniverseStructuresStructureIdOk**](../Model/GetUniverseStructuresStructureIdOk.md)
...
```php
getUniverseSystemJumps($datasource, $if_none_match): \EsiClient\Model\GetUniverseSystemJumps200Ok[]
```
...
[**\EsiClient\Model\GetUniverseSystemJumps200Ok[]**](../Model/GetUniverseSystemJumps200Ok.md)
...
```php
getUniverseSystemKills($datasource, $if_none_match): \EsiClient\Model\GetUniverseSystemKills200Ok[]
```
...
[**\EsiClient\Model\GetUniverseSystemKills200Ok[]**](../Model/GetUniverseSystemKills200Ok.md)
...
```php
getUniverseSystemsSystemId($system_id, $accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseSystemsSystemIdOk
```
...
[**\EsiClient\Model\GetUniverseSystemsSystemIdOk**](../Model/GetUniverseSystemsSystemIdOk.md)
...
```php
getUniverseTypesTypeId($type_id, $accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetUniverseTypesTypeIdOk
```
...
[**\EsiClient\Model\GetUniverseTypesTypeIdOk**](../Model/GetUniverseTypesTypeIdOk.md)
...
```php
postUniverseIds($names, $accept_language, $datasource, $language): \EsiClient\Model\PostUniverseIdsOk
```
...
[**\EsiClient\Model\PostUniverseIdsOk**](../Model/PostUniverseIdsOk.md)
...
```php
postUniverseNames($ids, $datasource): \EsiClient\Model\PostUniverseNames200Ok[]
```
...
[**\EsiClient\Model\PostUniverseNames200Ok[]**](../Model/PostUniverseNames200Ok.md)
