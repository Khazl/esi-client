...
```php
getCharactersCharacterIdFwStats($character_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCharactersCharacterIdFwStatsOk
```
...
[**\EsiClient\Model\GetCharactersCharacterIdFwStatsOk**](../Model/GetCharactersCharacterIdFwStatsOk.md)
...
```php
getCorporationsCorporationIdFwStats($corporation_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCorporationsCorporationIdFwStatsOk
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdFwStatsOk**](../Model/GetCorporationsCorporationIdFwStatsOk.md)
...
```php
getFwLeaderboards($datasource, $if_none_match): \EsiClient\Model\GetFwLeaderboardsOk
```
...
[**\EsiClient\Model\GetFwLeaderboardsOk**](../Model/GetFwLeaderboardsOk.md)
...
```php
getFwLeaderboardsCharacters($datasource, $if_none_match): \EsiClient\Model\GetFwLeaderboardsCharactersOk
```
...
[**\EsiClient\Model\GetFwLeaderboardsCharactersOk**](../Model/GetFwLeaderboardsCharactersOk.md)
...
```php
getFwLeaderboardsCorporations($datasource, $if_none_match): \EsiClient\Model\GetFwLeaderboardsCorporationsOk
```
...
[**\EsiClient\Model\GetFwLeaderboardsCorporationsOk**](../Model/GetFwLeaderboardsCorporationsOk.md)
...
```php
getFwStats($datasource, $if_none_match): \EsiClient\Model\GetFwStats200Ok[]
```
...
[**\EsiClient\Model\GetFwStats200Ok[]**](../Model/GetFwStats200Ok.md)
...
```php
getFwSystems($datasource, $if_none_match): \EsiClient\Model\GetFwSystems200Ok[]
```
...
[**\EsiClient\Model\GetFwSystems200Ok[]**](../Model/GetFwSystems200Ok.md)
...
```php
getFwWars($datasource, $if_none_match): \EsiClient\Model\GetFwWars200Ok[]
```
...
[**\EsiClient\Model\GetFwWars200Ok[]**](../Model/GetFwWars200Ok.md)
