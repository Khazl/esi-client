...
$apiInstance = new EsiClient\Api\WarsApi(
...
```php
getWarsWarId($war_id, $datasource, $if_none_match): \EsiClient\Model\GetWarsWarIdOk
```
...
[**\EsiClient\Model\GetWarsWarIdOk**](../Model/GetWarsWarIdOk.md)
...
```php
getWarsWarIdKillmails($war_id, $datasource, $if_none_match, $page): \EsiClient\Model\GetWarsWarIdKillmails200Ok[]
```
...
[**\EsiClient\Model\GetWarsWarIdKillmails200Ok[]**](../Model/GetWarsWarIdKillmails200Ok.md)
