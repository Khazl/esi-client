...
```php
getCharactersCharacterIdIndustryJobs($character_id, $datasource, $if_none_match, $include_completed, $token): \EsiClient\Model\GetCharactersCharacterIdIndustryJobs200Ok[]
```
...
[**\EsiClient\Model\GetCharactersCharacterIdIndustryJobs200Ok[]**](../Model/GetCharactersCharacterIdIndustryJobs200Ok.md)
...
```php
getCharactersCharacterIdMining($character_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCharactersCharacterIdMining200Ok[]
```
...
[**\EsiClient\Model\GetCharactersCharacterIdMining200Ok[]**](../Model/GetCharactersCharacterIdMining200Ok.md)
...
```php
getCorporationCorporationIdMiningExtractions($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationCorporationIdMiningExtractions200Ok[]
```
...
[**\EsiClient\Model\GetCorporationCorporationIdMiningExtractions200Ok[]**](../Model/GetCorporationCorporationIdMiningExtractions200Ok.md)
...
```php
getCorporationCorporationIdMiningObservers($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationCorporationIdMiningObservers200Ok[]
```
...
[**\EsiClient\Model\GetCorporationCorporationIdMiningObservers200Ok[]**](../Model/GetCorporationCorporationIdMiningObservers200Ok.md)
...
```php
getCorporationCorporationIdMiningObserversObserverId($corporation_id, $observer_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationCorporationIdMiningObserversObserverId200Ok[]
```
...
[**\EsiClient\Model\GetCorporationCorporationIdMiningObserversObserverId200Ok[]**](../Model/GetCorporationCorporationIdMiningObserversObserverId200Ok.md)
...
```php
getCorporationsCorporationIdIndustryJobs($corporation_id, $datasource, $if_none_match, $include_completed, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdIndustryJobs200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdIndustryJobs200Ok[]**](../Model/GetCorporationsCorporationIdIndustryJobs200Ok.md)
...
```php
getIndustryFacilities($datasource, $if_none_match): \EsiClient\Model\GetIndustryFacilities200Ok[]
```
...
[**\EsiClient\Model\GetIndustryFacilities200Ok[]**](../Model/GetIndustryFacilities200Ok.md)
...
```php
getIndustrySystems($datasource, $if_none_match): \EsiClient\Model\GetIndustrySystems200Ok[]
```
...
[**\EsiClient\Model\GetIndustrySystems200Ok[]**](../Model/GetIndustrySystems200Ok.md)
