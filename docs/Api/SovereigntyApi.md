...
```php
getSovereigntyCampaigns($datasource, $if_none_match): \EsiClient\Model\GetSovereigntyCampaigns200Ok[]
```
...
[**\EsiClient\Model\GetSovereigntyCampaigns200Ok[]**](../Model/GetSovereigntyCampaigns200Ok.md)
...
```php
getSovereigntyMap($datasource, $if_none_match): \EsiClient\Model\GetSovereigntyMap200Ok[]
```
...
[**\EsiClient\Model\GetSovereigntyMap200Ok[]**](../Model/GetSovereigntyMap200Ok.md)
...
```php
getSovereigntyStructures($datasource, $if_none_match): \EsiClient\Model\GetSovereigntyStructures200Ok[]
```
...
[**\EsiClient\Model\GetSovereigntyStructures200Ok[]**](../Model/GetSovereigntyStructures200Ok.md)
