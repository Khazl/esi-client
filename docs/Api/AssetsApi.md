...
```php
getCharactersCharacterIdAssets($character_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCharactersCharacterIdAssets200Ok[]
```
...
[**\EsiClient\Model\GetCharactersCharacterIdAssets200Ok[]**](../Model/GetCharactersCharacterIdAssets200Ok.md)
...
```php
getCorporationsCorporationIdAssets($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdAssets200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdAssets200Ok[]**](../Model/GetCorporationsCorporationIdAssets200Ok.md)
...
```php
postCharactersCharacterIdAssetsLocations($character_id, $item_ids, $datasource, $token): \EsiClient\Model\PostCharactersCharacterIdAssetsLocations200Ok[]
```
...
[**\EsiClient\Model\PostCharactersCharacterIdAssetsLocations200Ok[]**](../Model/PostCharactersCharacterIdAssetsLocations200Ok.md)
...
```php
postCharactersCharacterIdAssetsNames($character_id, $item_ids, $datasource, $token): \EsiClient\Model\PostCharactersCharacterIdAssetsNames200Ok[]
```
...
[**\EsiClient\Model\PostCharactersCharacterIdAssetsNames200Ok[]**](../Model/PostCharactersCharacterIdAssetsNames200Ok.md)
...
```php
postCorporationsCorporationIdAssetsLocations($corporation_id, $item_ids, $datasource, $token): \EsiClient\Model\PostCorporationsCorporationIdAssetsLocations200Ok[]
```
...
[**\EsiClient\Model\PostCorporationsCorporationIdAssetsLocations200Ok[]**](../Model/PostCorporationsCorporationIdAssetsLocations200Ok.md)
...
```php
postCorporationsCorporationIdAssetsNames($corporation_id, $item_ids, $datasource, $token): \EsiClient\Model\PostCorporationsCorporationIdAssetsNames200Ok[]
```
...
[**\EsiClient\Model\PostCorporationsCorporationIdAssetsNames200Ok[]**](../Model/PostCorporationsCorporationIdAssetsNames200Ok.md)
