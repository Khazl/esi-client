...
```php
getAlliancesAllianceId($alliance_id, $datasource, $if_none_match): \EsiClient\Model\GetAlliancesAllianceIdOk
```
...
[**\EsiClient\Model\GetAlliancesAllianceIdOk**](../Model/GetAlliancesAllianceIdOk.md)
...
```php
getAlliancesAllianceIdIcons($alliance_id, $datasource, $if_none_match): \EsiClient\Model\GetAlliancesAllianceIdIconsOk
```
...
[**\EsiClient\Model\GetAlliancesAllianceIdIconsOk**](../Model/GetAlliancesAllianceIdIconsOk.md)
