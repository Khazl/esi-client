...
```php
getCorporationsCorporationId($corporation_id, $datasource, $if_none_match): \EsiClient\Model\GetCorporationsCorporationIdOk
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdOk**](../Model/GetCorporationsCorporationIdOk.md)
...
```php
getCorporationsCorporationIdAlliancehistory($corporation_id, $datasource, $if_none_match): \EsiClient\Model\GetCorporationsCorporationIdAlliancehistory200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdAlliancehistory200Ok[]**](../Model/GetCorporationsCorporationIdAlliancehistory200Ok.md)
...
```php
getCorporationsCorporationIdBlueprints($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdBlueprints200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdBlueprints200Ok[]**](../Model/GetCorporationsCorporationIdBlueprints200Ok.md)
...
```php
getCorporationsCorporationIdContainersLogs($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdContainersLogs200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdContainersLogs200Ok[]**](../Model/GetCorporationsCorporationIdContainersLogs200Ok.md)
...
```php
getCorporationsCorporationIdDivisions($corporation_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCorporationsCorporationIdDivisionsOk
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdDivisionsOk**](../Model/GetCorporationsCorporationIdDivisionsOk.md)
...
```php
getCorporationsCorporationIdFacilities($corporation_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCorporationsCorporationIdFacilities200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdFacilities200Ok[]**](../Model/GetCorporationsCorporationIdFacilities200Ok.md)
...
```php
getCorporationsCorporationIdIcons($corporation_id, $datasource, $if_none_match): \EsiClient\Model\GetCorporationsCorporationIdIconsOk
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdIconsOk**](../Model/GetCorporationsCorporationIdIconsOk.md)
...
```php
getCorporationsCorporationIdMedals($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdMedals200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdMedals200Ok[]**](../Model/GetCorporationsCorporationIdMedals200Ok.md)
...
```php
getCorporationsCorporationIdMedalsIssued($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdMedalsIssued200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdMedalsIssued200Ok[]**](../Model/GetCorporationsCorporationIdMedalsIssued200Ok.md)
...
```php
getCorporationsCorporationIdMembersTitles($corporation_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCorporationsCorporationIdMembersTitles200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdMembersTitles200Ok[]**](../Model/GetCorporationsCorporationIdMembersTitles200Ok.md)
...
```php
getCorporationsCorporationIdMembertracking($corporation_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCorporationsCorporationIdMembertracking200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdMembertracking200Ok[]**](../Model/GetCorporationsCorporationIdMembertracking200Ok.md)
...
```php
getCorporationsCorporationIdRoles($corporation_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCorporationsCorporationIdRoles200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdRoles200Ok[]**](../Model/GetCorporationsCorporationIdRoles200Ok.md)
...
```php
getCorporationsCorporationIdRolesHistory($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdRolesHistory200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdRolesHistory200Ok[]**](../Model/GetCorporationsCorporationIdRolesHistory200Ok.md)
...
```php
getCorporationsCorporationIdShareholders($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdShareholders200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdShareholders200Ok[]**](../Model/GetCorporationsCorporationIdShareholders200Ok.md)
...
```php
getCorporationsCorporationIdStandings($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdStandings200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdStandings200Ok[]**](../Model/GetCorporationsCorporationIdStandings200Ok.md)
...
```php
getCorporationsCorporationIdStarbases($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdStarbases200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdStarbases200Ok[]**](../Model/GetCorporationsCorporationIdStarbases200Ok.md)
...
```php
getCorporationsCorporationIdStarbasesStarbaseId($corporation_id, $starbase_id, $system_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCorporationsCorporationIdStarbasesStarbaseIdOk
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdStarbasesStarbaseIdOk**](../Model/GetCorporationsCorporationIdStarbasesStarbaseIdOk.md)
...
```php
getCorporationsCorporationIdStructures($corporation_id, $accept_language, $datasource, $if_none_match, $language, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdStructures200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdStructures200Ok[]**](../Model/GetCorporationsCorporationIdStructures200Ok.md)
...
```php
getCorporationsCorporationIdTitles($corporation_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCorporationsCorporationIdTitles200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdTitles200Ok[]**](../Model/GetCorporationsCorporationIdTitles200Ok.md)
