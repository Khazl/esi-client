...
```php
getCharactersCharacterIdClones($character_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCharactersCharacterIdClonesOk
```
...
$apiInstance = new EsiClient\Api\ClonesApi(
...
[**\EsiClient\Model\GetCharactersCharacterIdClonesOk**](../Model/GetCharactersCharacterIdClonesOk.md)
