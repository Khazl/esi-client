...
```php
getCharactersCharacterIdPlanets($character_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCharactersCharacterIdPlanets200Ok[]
```
...
[**\EsiClient\Model\GetCharactersCharacterIdPlanets200Ok[]**](../Model/GetCharactersCharacterIdPlanets200Ok.md)
...
```php
getCharactersCharacterIdPlanetsPlanetId($character_id, $planet_id, $datasource, $token): \EsiClient\Model\GetCharactersCharacterIdPlanetsPlanetIdOk
```
...
[**\EsiClient\Model\GetCharactersCharacterIdPlanetsPlanetIdOk**](../Model/GetCharactersCharacterIdPlanetsPlanetIdOk.md)
...
```php
getCorporationsCorporationIdCustomsOffices($corporation_id, $datasource, $if_none_match, $page, $token): \EsiClient\Model\GetCorporationsCorporationIdCustomsOffices200Ok[]
```
...
[**\EsiClient\Model\GetCorporationsCorporationIdCustomsOffices200Ok[]**](../Model/GetCorporationsCorporationIdCustomsOffices200Ok.md)
...
```php
getUniverseSchematicsSchematicId($schematic_id, $datasource, $if_none_match): \EsiClient\Model\GetUniverseSchematicsSchematicIdOk
```
...
[**\EsiClient\Model\GetUniverseSchematicsSchematicIdOk**](../Model/GetUniverseSchematicsSchematicIdOk.md)
