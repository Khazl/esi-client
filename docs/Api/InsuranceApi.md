...
```php
getInsurancePrices($accept_language, $datasource, $if_none_match, $language): \EsiClient\Model\GetInsurancePrices200Ok[]
```
...
[**\EsiClient\Model\GetInsurancePrices200Ok[]**](../Model/GetInsurancePrices200Ok.md)
