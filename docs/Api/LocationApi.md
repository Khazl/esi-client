...
```php
getCharactersCharacterIdLocation($character_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCharactersCharacterIdLocationOk
```
...
[**\EsiClient\Model\GetCharactersCharacterIdLocationOk**](../Model/GetCharactersCharacterIdLocationOk.md)
...
```php
getCharactersCharacterIdOnline($character_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCharactersCharacterIdOnlineOk
```
...
[**\EsiClient\Model\GetCharactersCharacterIdOnlineOk**](../Model/GetCharactersCharacterIdOnlineOk.md)
...
```php
getCharactersCharacterIdShip($character_id, $datasource, $if_none_match, $token): \EsiClient\Model\GetCharactersCharacterIdShipOk
```
...
[**\EsiClient\Model\GetCharactersCharacterIdShipOk**](../Model/GetCharactersCharacterIdShipOk.md)
