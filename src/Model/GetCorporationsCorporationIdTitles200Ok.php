...
class GetCorporationsCorporationIdTitles200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_corporations_corporation_id_titles_200_ok';
     ...
     * @return string[]
     */
    public static function getGrantableRolesAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getGrantableRolesAtBaseAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getGrantableRolesAtHqAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getGrantableRolesAtOtherAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getRolesAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getRolesAtBaseAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getRolesAtHqAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getRolesAtOtherAllowableValues()
    {
        return [
    ...
    */
     ...
     * @return $this
     */
    public function setGrantableRoles(?array $grantable_roles): static
    {
        if (is_null($grantable_roles)) {
            throw new InvalidArgumentException('non-nullable grantable_roles cannot be null');
        }
        $allowedValues = self::getGrantableRolesAllowableValues();
     ...
     * @return string[]|null
     */
    public function getGrantableRolesAtBase(): ?array
    {
     ...
     * @return $this
     */
    public function setGrantableRolesAtBase(?array $grantable_roles_at_base): static
    {
        if (is_null($grantable_roles_at_base)) {
            throw new InvalidArgumentException('non-nullable grantable_roles_at_base cannot be null');
        }
        $allowedValues = self::getGrantableRolesAtBaseAllowableValues();
     ...
     * @return string[]|null
     */
    public function getGrantableRolesAtHq(): ?array
    {
     ...
     * @return $this
     */
    public function setGrantableRolesAtHq(?array $grantable_roles_at_hq): static
    {
        if (is_null($grantable_roles_at_hq)) {
            throw new InvalidArgumentException('non-nullable grantable_roles_at_hq cannot be null');
        }
        $allowedValues = self::getGrantableRolesAtHqAllowableValues();
     ...
     * @return string[]|null
     */
    public function getGrantableRolesAtOther(): ?array
    {
     ...
     * @return $this
     */
    public function setGrantableRolesAtOther(?array $grantable_roles_at_other): static
    {
        ...
        $allowedValues = self::getGrantableRolesAtOtherAllowableValues();
    ...
    public function setRoles(?array $roles): static
    {
        ...
        $allowedValues = self::getRolesAllowableValues();
     ...
     * @return $this
     */
    public function setRolesAtBase(?array $roles_at_base): static
    {
        if (is_null($roles_at_base)) {
            throw new InvalidArgumentException('non-nullable roles_at_base cannot be null');
        }
        $allowedValues = self::getRolesAtBaseAllowableValues();
     ...
     * @return $this
     */
    public function setRolesAtHq(?array $roles_at_hq): static
    {
        if (is_null($roles_at_hq)) {
            throw new InvalidArgumentException('non-nullable roles_at_hq cannot be null');
        }
        $allowedValues = self::getRolesAtHqAllowableValues();
     ...
     * @return $this
     */
    public function setRolesAtOther(?array $roles_at_other): static
    {
        if (is_null($roles_at_other)) {
            throw new InvalidArgumentException('non-nullable roles_at_other cannot be null');
        }
        $allowedValues = self::getRolesAtOtherAllowableValues();
     ...
     * @return $this
     */
    public function setTitleId(?int $title_id): static
    {
        if (is_null($title_id)) {
