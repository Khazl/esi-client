...
class GetCorporationsCorporationIdStandings200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_corporations_corporation_id_standings_200_ok';
     ...
     * @return string[]
     */
    public static function getFromTypeAllowableValues()
    {
        return [
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getFromTypeAllowableValues();
     ...
     * @return $this
     */
    public function setFromId(int $from_id): static
    {
        if (is_null($from_id)) {
     ...
     * @return $this
     */
    public function setFromType(string $from_type): static
    {
