...
class GetCharactersCharacterIdMailMailIdRecipient implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_mail_mail_id_recipient';
     ...
     * @return string[]
     */
    public static function getRecipientTypeAllowableValues()
    {
        return [
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getRecipientTypeAllowableValues();
