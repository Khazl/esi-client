...
class GetCharactersCharacterIdSkillsSkill implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_skills_skill';
    ...
    */
     ...
     * @return int
     */
    public function getActiveSkillLevel(): int
    {
     ...
     * @return $this
     */
    public function setActiveSkillLevel(int $active_skill_level): static
    {
     ...
     * @return int
     */
    public function getSkillpointsInSkill(): int
    {
     ...
     * @return $this
     */
    public function setSkillpointsInSkill(int $skillpoints_in_skill): static
    {
     ...
     * @return int
     */
    public function getTrainedSkillLevel(): int
    {
     ...
     * @return $this
     */
    public function setTrainedSkillLevel(int $trained_skill_level): static
    {
