...
class GetUniverseSystemKills200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_universe_system_kills_200_ok';
    ...
    */
     ...
     * @return int
     */
    public function getNpcKills(): int
    {
     ...
     * @return $this
     */
    public function setNpcKills(int $npc_kills): static
    {
     ...
     * @return int
     */
    public function getPodKills(): int
    {
     ...
     * @return $this
     */
    public function setPodKills(int $pod_kills): static
    {
     ...
     * @return int
     */
    public function getShipKills(): int
    {
     ...
     * @return $this
     */
    public function setShipKills(int $ship_kills): static
    {
