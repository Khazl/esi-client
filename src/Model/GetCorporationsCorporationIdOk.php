...
class GetCorporationsCorporationIdOk implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_corporations_corporation_id_ok';
    ...
    */
     ...
     * @return $this
     */
    public function setCeoId(int $ceo_id): static
    {
        if (is_null($ceo_id)) {
     ...
     * @return $this
     */
    public function setDateFounded(?\DateTime $date_founded): static
    {
     ...
     * @return $this
     */
    public function setHomeStationId(?int $home_station_id): static
    {
     ...
     * @return bool|null
     */
    public function getWarEligible(): ?bool
    {
     ...
     * @return $this
     */
    public function setWarEligible(?bool $war_eligible): static
    {
