...
class GetCharactersCharacterIdAttributesOk implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_attributes_ok';
    ...
    */
     ...
     */
    public function getAccruedRemapCooldownDate(): ?\DateTime
    {
     ...
     * @return $this
     */
    public function setAccruedRemapCooldownDate(?\DateTime $accrued_remap_cooldown_date): static
    {
     ...
     * @return int|null
     */
    public function getBonusRemaps(): ?int
    {
     ...
     * @return $this
     */
    public function setBonusRemaps(?int $bonus_remaps): static
    {
     ...
     * @return \DateTime|null
     */
    public function getLastRemapDate(): ?\DateTime
    {
     ...
     * @return $this
     */
    public function setLastRemapDate(?\DateTime $last_remap_date): static
    {
