...
class GetCharactersCharacterIdAgentsResearch200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_agents_research_200_ok';
    ...
    */
     ...
     * @return float
     */
    public function getPointsPerDay(): float
    {
     ...
     * @return $this
     */
    public function setPointsPerDay(float $points_per_day): static
    {
     ...
     * @return float
     */
    public function getRemainderPoints(): float
    {
     ...
     * @return $this
     */
    public function setRemainderPoints(float $remainder_points): static
    {
     ...
     * @return $this
     */
    public function setSkillTypeId(int $skill_type_id): static
    {
