...
class GetCharactersCharacterIdMedals200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_medals_200_ok';
    ...
    protected static array $openAPITypes = [
        ...
        'date' => '\DateTime',
        'description' => 'string',
        'graphics' => '\EsiClient\Model\GetCharactersCharacterIdMedalsGraphic[]',
        'issuer_id' => 'int',
        'medal_id' => 'int',
        'reason' => 'string',
        'status' => 'string',
    ...
    */
     ...
     * Gets graphics
     *
     * @return \EsiClient\Model\GetCharactersCharacterIdMedalsGraphic[]
     */
     ...
     * Sets graphics
     *
     * @param \EsiClient\Model\GetCharactersCharacterIdMedalsGraphic[] $graphics graphics array
     *
     * @return $this
     */
    public function setGraphics(array $graphics): static
    {
        if (is_null($graphics)) {
