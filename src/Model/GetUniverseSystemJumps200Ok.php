...
class GetUniverseSystemJumps200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_universe_system_jumps_200_ok';
    ...
    */
     ...
     * @return int
     */
    public function getShipJumps(): int
    {
     ...
     * @return $this
     */
    public function setShipJumps(int $ship_jumps): static
    {
