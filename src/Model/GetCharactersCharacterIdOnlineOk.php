...
class GetCharactersCharacterIdOnlineOk implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_online_ok';
    ...
    */
     ...
     * @return $this
     */
    public function setLastLogout(?\DateTime $last_logout): static
    {
     ...
     * @return $this
     */
    public function setLogins(?int $logins): static
    {
        if (is_null($logins)) {
