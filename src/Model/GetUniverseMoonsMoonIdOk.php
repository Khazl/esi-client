...
class GetUniverseMoonsMoonIdOk implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_universe_moons_moon_id_ok';
    ...
    protected static array $openAPITypes = [
        'moon_id' => 'int',
        'name' => 'string',
        'position' => '\EsiClient\Model\GetUniverseMoonsMoonIdPosition',
        'system_id' => 'int'
    ];
    ...
    */
     ...
     * Gets position
     *
     * @return \EsiClient\Model\GetUniverseMoonsMoonIdPosition
     */
    public function getPosition(): \EsiClient\Model\GetUniverseMoonsMoonIdPosition
    {
     ...
     * Sets position
     *
     * @param \EsiClient\Model\GetUniverseMoonsMoonIdPosition $position position
     *
     * @return $this
     */
    public function setPosition(\EsiClient\Model\GetUniverseMoonsMoonIdPosition $position): static
    {
        if (is_null($position)) {
