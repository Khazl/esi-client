...
class GetCorporationsCorporationIdOrdersHistory200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_corporations_corporation_id_orders_history_200_ok';
     ...
     * @return string[]
     */
    public static function getRangeAllowableValues()
    {
        return [
            self::RANGE__1,
            self::RANGE__10,
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getRangeAllowableValues();
     ...
     * @return $this
     */
    public function setEscrow(?float $escrow): static
    {
        if (is_null($escrow)) {
     ...
     * @return bool|null
     */
    public function getIsBuyOrder(): ?bool
    {
     ...
     * @return $this
     */
    public function setIsBuyOrder(?bool $is_buy_order): static
    {
     ...
     * @return $this
     */
    public function setIssued(\DateTime $issued): static
    {
        if (is_null($issued)) {
     ...
     * @return $this
     */
    public function setIssuedBy(?int $issued_by): static
    {
     ...
     * @return $this
     */
    public function setMinVolume(?int $min_volume): static
    {
     ...
     * @return $this
     */
    public function setVolumeRemain(int $volume_remain): static
    {
     ...
     * @return $this
     */
    public function setVolumeTotal(int $volume_total): static
    {
     ...
     * @return int
     */
    public function getWalletDivision(): int
    {
     ...
     * @return $this
     */
    public function setWalletDivision(int $wallet_division): static
    {
