...
class GetUniverseSystemsSystemIdOk implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_universe_systems_system_id_ok';
    ...
    protected static array $openAPITypes = [
        ...
        'name' => 'string',
        'planets' => '\EsiClient\Model\GetUniverseSystemsSystemIdPlanet[]',
        'position' => '\EsiClient\Model\GetUniverseSystemsSystemIdPosition',
    ...
    */
     ...
     * Gets planets
     *
     * @return \EsiClient\Model\GetUniverseSystemsSystemIdPlanet[]|null
     */
     ...
     * Sets planets
     *
     * @param \EsiClient\Model\GetUniverseSystemsSystemIdPlanet[]|null $planets planets array
     *
     * @return $this
     */
    public function setPlanets(?array $planets): static
    {
        if (is_null($planets)) {
     ...
     * Gets position
     *
     * @return \EsiClient\Model\GetUniverseSystemsSystemIdPosition
     */
    public function getPosition(): \EsiClient\Model\GetUniverseSystemsSystemIdPosition
    {
     ...
     * Sets position
     *
     * @param \EsiClient\Model\GetUniverseSystemsSystemIdPosition $position position
     *
     * @return $this
     */
    public function setPosition(\EsiClient\Model\GetUniverseSystemsSystemIdPosition $position): static
    {
        if (is_null($position)) {
     ...
     * @return $this
     */
    public function setSecurityClass(?string $security_class): static
    {
     ...
     * @return $this
     */
    public function setStarId(?int $star_id): static
    {
        if (is_null($star_id)) {
     ...
     * @return int[]|null
     */
    public function getStargates(): ?array
    {
     ...
     * @return $this
     */
    public function setStargates(?array $stargates): static
    {
