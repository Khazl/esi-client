...
class GetCharactersCharacterIdClonesJumpClone implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_clones_jump_clone';
    ...
    */
     ...
     * @return int
     */
    public function getJumpCloneId(): int
    {
     ...
     * @return $this
     */
    public function setJumpCloneId(int $jump_clone_id): static
    {
