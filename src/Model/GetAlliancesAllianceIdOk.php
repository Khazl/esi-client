...
class GetAlliancesAllianceIdOk implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_alliances_alliance_id_ok';
    ...
    */
     ...
     * @return $this
     */
    public function setCreatorCorporationId(int $creator_corporation_id): static
    {
     ...
     * @return $this
     */
    public function setExecutorCorporationId(?int $executor_corporation_id): static
    {
