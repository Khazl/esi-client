...
class GetCharactersCharacterIdMail200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_mail_200_ok';
    ...
    protected static array $openAPITypes = [
        ...
        'labels' => 'int[]',
        'mail_id' => 'int',
        'recipients' => '\EsiClient\Model\GetCharactersCharacterIdMailRecipient[]',
        'subject' => 'string',
        'timestamp' => '\DateTime'
    ];
    ...
    */
     ...
     * @return $this
     */
    public function setMailId(?int $mail_id): static
    {
        if (is_null($mail_id)) {
     ...
     * Gets recipients
     *
     * @return \EsiClient\Model\GetCharactersCharacterIdMailRecipient[]|null
     */
     ...
     * Sets recipients
     *
     * @param \EsiClient\Model\GetCharactersCharacterIdMailRecipient[]|null $recipients Recipients of the mail
     *
     * @return $this
     */
