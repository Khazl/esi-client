...
class GetCharactersCharacterIdPlanetsPlanetIdLink implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_planets_planet_id_link';
    ...
    */
     ...
     * @return $this
     */
    public function setDestinationPinId(int $destination_pin_id): static
    {
     ...
     * @return $this
     */
    public function setLinkLevel(int $link_level): static
    {
     ...
     * @return $this
     */
    public function setSourcePinId(int $source_pin_id): static
    {
