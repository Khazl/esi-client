...
class GetCharactersCharacterIdWalletTransactions200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_wallet_transactions_200_ok';
    ...
    */
     ...
     * @return $this
     */
    public function setIsPersonal(bool $is_personal): static
    {
     ...
     * @return int
     */
    public function getJournalRefId(): int
    {
     ...
     * @return $this
     */
    public function setJournalRefId(int $journal_ref_id): static
    {
