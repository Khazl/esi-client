...
class GetCharactersCharacterIdFleetOk implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_fleet_ok';
    ...
    */
     ...
     * @return int
     */
    public function getFleetBossId(): int
    {
     ...
     * @return $this
     */
    public function setFleetBossId(int $fleet_boss_id): static
    {
     ...
     * @return $this
     */
    public function setFleetId(int $fleet_id): static
    {
        if (is_null($fleet_id)) {
