...
class GetCharactersCharacterIdFittings200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_fittings_200_ok';
    ...
    protected static array $openAPITypes = [
        'description' => 'string',
        'fitting_id' => 'int',
        'items' => '\EsiClient\Model\GetCharactersCharacterIdFittingsItem[]',
        'name' => 'string',
        'ship_type_id' => 'int'
    ];
    ...
    */
     ...
     * @return int
     */
    public function getFittingId(): int
    {
     ...
     * @return $this
     */
    public function setFittingId(int $fitting_id): static
    {
     ...
     * Gets items
     *
     * @return \EsiClient\Model\GetCharactersCharacterIdFittingsItem[]
     */
     ...
     * Sets items
     *
     * @param \EsiClient\Model\GetCharactersCharacterIdFittingsItem[] $items items array
     *
     * @return $this
     */
