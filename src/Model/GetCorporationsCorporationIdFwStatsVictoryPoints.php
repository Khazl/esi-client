...
class GetCorporationsCorporationIdFwStatsVictoryPoints implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_corporations_corporation_id_fw_stats_victory_points';
    ...
    */
     ...
     * @return $this
     */
    public function setLastWeek(int $last_week): static
    {
     ...
     * @return $this
     */
    public function setYesterday(int $yesterday): static
    {
