...
class PostUiOpenwindowNewmailNewMail implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_ui_openwindow_newmail_new_mail';
    ...
    */
     ...
     * @return int|null
     */
    public function getToCorpOrAllianceId(): ?int
    {
     ...
     * @return $this
     */
    public function setToCorpOrAllianceId(?int $to_corp_or_alliance_id): static
    {
     ...
     * @return int|null
     */
    public function getToMailingListId(): ?int
    {
     ...
     * @return $this
     */
    public function setToMailingListId(?int $to_mailing_list_id): static
    {
