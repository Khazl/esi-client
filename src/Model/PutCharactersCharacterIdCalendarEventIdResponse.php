...
class PutCharactersCharacterIdCalendarEventIdResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'put_characters_character_id_calendar_event_id_response';
     ...
     * @return string[]
     */
    public static function getResponseAllowableValues()
    {
        return [
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getResponseAllowableValues();
