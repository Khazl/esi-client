...
class PostCharactersCharacterIdFittingsFitting implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'post_characters_character_id_fittings_fitting';
    ...
    protected static array $openAPITypes = [
        'description' => 'string',
        'items' => '\EsiClient\Model\PostCharactersCharacterIdFittingsItem[]',
        'name' => 'string',
        'ship_type_id' => 'int'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \EsiClient\Model\PostCharactersCharacterIdFittingsItem[]
     */
     ...
     * Sets items
     *
     * @param \EsiClient\Model\PostCharactersCharacterIdFittingsItem[] $items items array
     *
     * @return $this
     */
