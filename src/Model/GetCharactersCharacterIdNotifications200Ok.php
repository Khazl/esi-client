...
class GetCharactersCharacterIdNotifications200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_characters_character_id_notifications_200_ok';
     ...
     * @return string[]
     */
    public static function getSenderTypeAllowableValues()
    {
        return [
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getSenderTypeAllowableValues();
