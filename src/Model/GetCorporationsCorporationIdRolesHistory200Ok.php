...
class GetCorporationsCorporationIdRolesHistory200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_corporations_corporation_id_roles_history_200_ok';
     ...
     * @return string[]
     */
    public static function getNewRolesAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getOldRolesAllowableValues()
    {
        return [
     ...
     * @return string[]
     */
    public static function getRoleTypeAllowableValues()
    {
        return [
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getRoleTypeAllowableValues();
     ...
     * @return $this
     */
    public function setNewRoles(array $new_roles): static
    {
        if (is_null($new_roles)) {
            throw new InvalidArgumentException('non-nullable new_roles cannot be null');
        }
        $allowedValues = self::getNewRolesAllowableValues();
     ...
     * @return $this
     */
    public function setOldRoles(array $old_roles): static
    {
        if (is_null($old_roles)) {
            throw new InvalidArgumentException('non-nullable old_roles cannot be null');
        }
        $allowedValues = self::getOldRolesAllowableValues();
