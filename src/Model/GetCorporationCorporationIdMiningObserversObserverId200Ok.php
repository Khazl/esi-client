...
class GetCorporationCorporationIdMiningObserversObserverId200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_corporation_corporation_id_mining_observers_observer_id_200_ok';
    ...
    */
     ...
     * @return int
     */
    public function getRecordedCorporationId(): int
    {
     ...
     * @return $this
     */
    public function setRecordedCorporationId(int $recorded_corporation_id): static
    {
