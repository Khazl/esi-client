...
class GetUniverseStarsStarIdOk implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_universe_stars_star_id_ok';
     ...
     * @return string[]
     */
    public static function getSpectralClassAllowableValues()
    {
        return [
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getSpectralClassAllowableValues();
     ...
     * @return $this
     */
    public function setSpectralClass(string $spectral_class): static
    {
