...
class GetUniverseSystemsSystemIdPlanet implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_universe_systems_system_id_planet';
    ...
    */
     ...
     * @return int[]|null
     */
    public function getAsteroidBelts(): ?array
    {
     ...
     * @return $this
     */
    public function setAsteroidBelts(?array $asteroid_belts): static
    {
     ...
     * @return $this
     */
    public function setMoons(?array $moons): static
    {
        if (is_null($moons)) {
