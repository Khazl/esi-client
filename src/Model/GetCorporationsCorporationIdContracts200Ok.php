...
class GetCorporationsCorporationIdContracts200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_corporations_corporation_id_contracts_200_ok';
    ...
    */
     ...
     * @return $this
     */
    public function setAcceptorId(int $acceptor_id): static
    {
     ...
     * @return $this
     */
    public function setAssigneeId(int $assignee_id): static
    {
     ...
     * @return $this
     */
    public function setBuyout(?float $buyout): static
    {
        if (is_null($buyout)) {
     ...
     * @return $this
     */
    public function setCollateral(?float $collateral): static
    {
     ...
     * @return $this
     */
    public function setDateAccepted(?\DateTime $date_accepted): static
    {
     ...
     * @return $this
     */
    public function setDateCompleted(?\DateTime $date_completed): static
    {
     ...
     * @return $this
     */
    public function setDateExpired(\DateTime $date_expired): static
    {
     ...
     * @return $this
     */
    public function setDateIssued(\DateTime $date_issued): static
    {
     ...
     * @return $this
     */
    public function setDaysToComplete(?int $days_to_complete): static
    {
     ...
     * @return int|null
     */
    public function getEndLocationId(): ?int
    {
     ...
     * @return $this
     */
    public function setEndLocationId(?int $end_location_id): static
    {
     ...
     * @return bool
     */
    public function getForCorporation(): bool
    {
     ...
     * @return $this
     */
    public function setForCorporation(bool $for_corporation): static
    {
     ...
     * @return int
     */
    public function getIssuerCorporationId(): int
    {
     ...
     * @return $this
     */
    public function setIssuerCorporationId(int $issuer_corporation_id): static
    {
     ...
     * @return $this
     */
    public function setStartLocationId(?int $start_location_id): static
    {
