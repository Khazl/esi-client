...
class GetWarsWarIdOk implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_wars_war_id_ok';
    ...
    protected static array $openAPITypes = [
        'aggressor' => '\EsiClient\Model\GetWarsWarIdAggressor',
        'allies' => '\EsiClient\Model\GetWarsWarIdAlly[]',
        'declared' => '\DateTime',
        'defender' => '\EsiClient\Model\GetWarsWarIdDefender',
        'finished' => '\DateTime',
        'id' => 'int',
        'mutual' => 'bool',
    ...
    */
     ...
     * Gets aggressor
     *
     * @return \EsiClient\Model\GetWarsWarIdAggressor
     */
    public function getAggressor(): \EsiClient\Model\GetWarsWarIdAggressor
    {
     ...
     * Sets aggressor
     *
     * @param \EsiClient\Model\GetWarsWarIdAggressor $aggressor aggressor
     *
     * @return $this
     */
    public function setAggressor(\EsiClient\Model\GetWarsWarIdAggressor $aggressor): static
    {
     ...
     * Gets allies
     *
     * @return \EsiClient\Model\GetWarsWarIdAlly[]|null
     */
     ...
     * Sets allies
     *
     * @param \EsiClient\Model\GetWarsWarIdAlly[]|null $allies allied corporations or alliances, each object contains either corporation_id or alliance_id
     *
     * @return $this
     */
    public function setAllies(?array $allies): static
    {
        if (is_null($allies)) {
     ...
     * @return \DateTime
     */
    public function getDeclared(): \DateTime
    {
     ...
     * @return $this
     */
    public function setDeclared(\DateTime $declared): static
    {
        if (is_null($declared)) {
     ...
     * Gets defender
     *
     * @return \EsiClient\Model\GetWarsWarIdDefender
     */
    public function getDefender(): \EsiClient\Model\GetWarsWarIdDefender
    {
     ...
     * Sets defender
     *
     * @param \EsiClient\Model\GetWarsWarIdDefender $defender defender
     *
     * @return $this
     */
    public function setDefender(\EsiClient\Model\GetWarsWarIdDefender $defender): static
    {
        if (is_null($defender)) {
     ...
     * @return $this
     */
    public function setFinished(?\DateTime $finished): static
    {
        if (is_null($finished)) {
     ...
     * @return bool
     */
    public function getOpenForAllies(): bool
    {
     ...
     * @return $this
     */
    public function setOpenForAllies(bool $open_for_allies): static
    {
     ...
     * @return \DateTime|null
     */
    public function getRetracted(): ?\DateTime
    {
     ...
     * @return $this
     */
    public function setRetracted(?\DateTime $retracted): static
    {
