...
class GetCorporationsCorporationIdAssets200Ok implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'get_corporations_corporation_id_assets_200_ok';
     ...
     * @return string[]
     */
    public static function getLocationTypeAllowableValues()
    {
        return [
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        $allowedValues = self::getLocationTypeAllowableValues();
