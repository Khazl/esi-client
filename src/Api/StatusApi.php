...
class StatusApi
{
     ...
     * @return \EsiClient\Model\GetStatusOk|\EsiClient\Model\BadRequest|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
     */
    public function getStatus(
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['getStatus'][0]
    ): \EsiClient\Model\GetStatusOk|\EsiClient\Model\BadRequest|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \EsiClient\Model\GetStatusOk|\EsiClient\Model\BadRequest|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\EsiClient\Model\GetStatusOk';
        $request = $this->getStatusRequest($datasource, $if_none_match, $contentType);
