...
class RoutesApi
{
     ...
     * @return int[]|\EsiClient\Model\BadRequest|\EsiClient\Model\GetRouteOriginDestinationNotFound|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
     */
    public function getRouteOriginDestination(
        int $destination,
        int $origin,
        ?array $avoid = null,
        ...
        string $contentType = self::contentTypes['getRouteOriginDestination'][0]
    ): array|\EsiClient\Model\BadRequest|\EsiClient\Model\GetRouteOriginDestinationNotFound|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of int[]|\EsiClient\Model\BadRequest|\EsiClient\Model\GetRouteOriginDestinationNotFound|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRouteOriginDestinationWithHttpInfo(
        int $destination,
        int $origin,
        ?array $avoid = null,
        ?array $connections = null,
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 404:
                    return $this->handleResponseWithDataType(
                        '\EsiClient\Model\GetRouteOriginDestinationNotFound',
                        $request,
                        $response,
                    );
                case 420:
     ...
     */
    public function getRouteOriginDestinationAsync(
        int $destination,
        int $origin,
        ?array $avoid = null,
        ?array $connections = null,
     ...
     * @return PromiseInterface
     */
    public function getRouteOriginDestinationAsyncWithHttpInfo(
        int $destination,
        int $origin,
        ?array $avoid = null,
        ?array $connections = null,
     ...
     */
    public function getRouteOriginDestinationRequest(
        int $destination,
        int $origin,
        ?array $avoid = null,
        ?array $connections = null,
