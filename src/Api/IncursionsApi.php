...
class IncursionsApi
{
     ...
     * @return \EsiClient\Model\GetIncursions200Ok[]|\EsiClient\Model\BadRequest|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
     */
    public function getIncursions(
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['getIncursions'][0]
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \EsiClient\Model\GetIncursions200Ok[]|\EsiClient\Model\BadRequest|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIncursionsWithHttpInfo(
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['getIncursions'][0]
    ): array
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\EsiClient\Model\GetIncursions200Ok[]',
                        $request,
                        $response,
                    );
                case 400:
     ...
     */
    public function getIncursionsAsync(
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['getIncursions'][0]
    ): PromiseInterface
     ...
     * @return PromiseInterface
     */
    public function getIncursionsAsyncWithHttpInfo(
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['getIncursions'][0]
    ): PromiseInterface
    {
        $returnType = '\EsiClient\Model\GetIncursions200Ok[]';
        $request = $this->getIncursionsRequest($datasource, $if_none_match, $contentType);
     ...
     */
    public function getIncursionsRequest(
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        string $contentType = self::contentTypes['getIncursions'][0]
    ): Request
