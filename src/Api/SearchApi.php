...
class SearchApi
{
     ...
     * @return \EsiClient\Model\GetCharactersCharacterIdSearchOk|\EsiClient\Model\BadRequest|\EsiClient\Model\Unauthorized|\EsiClient\Model\Forbidden|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
     */
    public function getCharactersCharacterIdSearch(
        array $categories,
        int $character_id,
        string $search,
        ...
        ?bool $strict = false,
        ?string $token = null,
        string $contentType = self::contentTypes['getCharactersCharacterIdSearch'][0]
    ): \EsiClient\Model\GetCharactersCharacterIdSearchOk|\EsiClient\Model\BadRequest|\EsiClient\Model\Unauthorized|\EsiClient\Model\Forbidden|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
    {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\EsiClient\Model\GetCharactersCharacterIdSearchOk',
                        $request,
                        $response,
                    );
                case 400:
     ...
     */
    public function getCharactersCharacterIdSearchAsync(
        array $categories,
        int $character_id,
        string $search,
        ?string $accept_language = 'en',
     ...
     * @return PromiseInterface
     */
    public function getCharactersCharacterIdSearchAsyncWithHttpInfo(
        array $categories,
        int $character_id,
        string $search,
        ?string $accept_language = 'en',
    ...
    {
        $returnType = '\EsiClient\Model\GetCharactersCharacterIdSearchOk';
        $request = $this->getCharactersCharacterIdSearchRequest($categories, $character_id, $search, $accept_language, $datasource, $if_none_match, $language, $strict, $token, $contentType);
     ...
     */
    public function getCharactersCharacterIdSearchRequest(
        array $categories,
        int $character_id,
        string $search,
        ?string $accept_language = 'en',
