...
class FittingsApi
{
     ...
     */
    public function deleteCharactersCharacterIdFittingsFittingId(
        int $character_id,
        int $fitting_id,
        ?string $datasource = 'tranquility',
        ?string $token = null,
        string $contentType = self::contentTypes['deleteCharactersCharacterIdFittingsFittingId'][0]
    ...
    {
        list($response) = $this->deleteCharactersCharacterIdFittingsFittingIdWithHttpInfo($character_id, $fitting_id, $datasource, $token, $contentType);
        return $response;
    }
     ...
     */
    public function deleteCharactersCharacterIdFittingsFittingIdWithHttpInfo(
        int $character_id,
        int $fitting_id,
        ?string $datasource = 'tranquility',
        ?string $token = null,
     ...
     */
    public function deleteCharactersCharacterIdFittingsFittingIdAsync(
        int $character_id,
        int $fitting_id,
        ?string $datasource = 'tranquility',
        ?string $token = null,
     ...
     * @return PromiseInterface
     */
    public function deleteCharactersCharacterIdFittingsFittingIdAsyncWithHttpInfo(
        int $character_id,
        int $fitting_id,
        ?string $datasource = 'tranquility',
        ?string $token = null,
     ...
     */
    public function deleteCharactersCharacterIdFittingsFittingIdRequest(
        int $character_id,
        int $fitting_id,
        ?string $datasource = 'tranquility',
        ?string $token = null,
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \EsiClient\Model\GetCharactersCharacterIdFittings200Ok[]|\EsiClient\Model\BadRequest|\EsiClient\Model\Unauthorized|\EsiClient\Model\Forbidden|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
     */
    public function getCharactersCharacterIdFittings(
        int $character_id,
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        ?string $token = null,
        string $contentType = self::contentTypes['getCharactersCharacterIdFittings'][0]
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \EsiClient\Model\GetCharactersCharacterIdFittings200Ok[]|\EsiClient\Model\BadRequest|\EsiClient\Model\Unauthorized|\EsiClient\Model\Forbidden|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCharactersCharacterIdFittingsWithHttpInfo(
        int $character_id,
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        ?string $token = null,
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\EsiClient\Model\GetCharactersCharacterIdFittings200Ok[]',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return PromiseInterface
     */
    public function getCharactersCharacterIdFittingsAsync(
        int $character_id,
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        ?string $token = null,
     ...
     * @return PromiseInterface
     */
    public function getCharactersCharacterIdFittingsAsyncWithHttpInfo(
        int $character_id,
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        ?string $token = null,
    ...
    {
        $returnType = '\EsiClient\Model\GetCharactersCharacterIdFittings200Ok[]';
        $request = $this->getCharactersCharacterIdFittingsRequest($character_id, $datasource, $if_none_match, $token, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCharactersCharacterIdFittingsRequest(
        int $character_id,
        ?string $datasource = 'tranquility',
        ?string $if_none_match = null,
        ?string $token = null,
     ...
     *
     * @param  int $character_id An EVE character ID (required)
     * @param  \EsiClient\Model\PostCharactersCharacterIdFittingsFitting $fitting Details about the new fitting (required)
     * @param  string|null $datasource The server name you would like data from (optional, default to 'tranquility')
     * @param  string|null $token Access token to use if unable to set a header (optional)
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \EsiClient\Model\PostCharactersCharacterIdFittingsCreated|\EsiClient\Model\BadRequest|\EsiClient\Model\Unauthorized|\EsiClient\Model\Forbidden|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
     */
    public function postCharactersCharacterIdFittings(
        int $character_id,
        \EsiClient\Model\PostCharactersCharacterIdFittingsFitting $fitting,
        ?string $datasource = 'tranquility',
        ?string $token = null,
        string $contentType = self::contentTypes['postCharactersCharacterIdFittings'][0]
    ): \EsiClient\Model\PostCharactersCharacterIdFittingsCreated|\EsiClient\Model\BadRequest|\EsiClient\Model\Unauthorized|\EsiClient\Model\Forbidden|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout
    {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \EsiClient\Model\PostCharactersCharacterIdFittingsCreated|\EsiClient\Model\BadRequest|\EsiClient\Model\Unauthorized|\EsiClient\Model\Forbidden|\EsiClient\Model\ErrorLimited|\EsiClient\Model\InternalServerError|\EsiClient\Model\ServiceUnavailable|\EsiClient\Model\GatewayTimeout, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    ): array
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\EsiClient\Model\PostCharactersCharacterIdFittingsCreated',
                        $request,
                        $response,
                    );
                case 400:
     ...
     * @return PromiseInterface
     */
    public function postCharactersCharacterIdFittingsAsync(
        int $character_id,
        \EsiClient\Model\PostCharactersCharacterIdFittingsFitting $fitting,
        ?string $datasource = 'tranquility',
        ?string $token = null,
     ...
     * @return PromiseInterface
     */
    public function postCharactersCharacterIdFittingsAsyncWithHttpInfo(
        int $character_id,
        \EsiClient\Model\PostCharactersCharacterIdFittingsFitting $fitting,
        ?string $datasource = 'tranquility',
        ?string $token = null,
    ...
    {
        $returnType = '\EsiClient\Model\PostCharactersCharacterIdFittingsCreated';
        $request = $this->postCharactersCharacterIdFittingsRequest($character_id, $fitting, $datasource, $token, $contentType);
