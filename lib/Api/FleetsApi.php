...
class FleetsApi
{
     ...
     *
     * @param  int $fleet_id ID for a fleet (required)
     * @param  \Swagger\Client\Model\Invitation $invitation Details of the invitation (required)
     * @param  string $datasource The server name you would like data from (optional, default to tranquility)
     * @param  string $token Access token to use if unable to set a header (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     *
     * @param  int $fleet_id ID for a fleet (required)
     * @param  \Swagger\Client\Model\NewSettings $new_settings What to update for this fleet (required)
     * @param  string $datasource The server name you would like data from (optional, default to tranquility)
     * @param  string $token Access token to use if unable to set a header (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @param  int $fleet_id ID for a fleet (required)
     * @param  int $member_id The character ID of a member in this fleet (required)
     * @param  \Swagger\Client\Model\Movement $movement Details of the invitation (required)
     * @param  string $datasource The server name you would like data from (optional, default to tranquility)
     * @param  string $token Access token to use if unable to set a header (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     *
     * @param  int $fleet_id ID for a fleet (required)
     * @param  \Swagger\Client\Model\Naming $naming New name of the squad (required)
     ...
     *
     * @param  int $fleet_id ID for a fleet (required)
     * @param  \Swagger\Client\Model\Naming $naming New name of the wing (required)
